...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // Открытие документа в фромате EPUB сразу после запуска приложения
        ...
        folioReader.setConfig(config, true)
                .openBook("file:///android_asset/bhagavad_gita.epub"); // здесь описывается название книги


//Открываем книгу из внутренних файлов приложения из папки RAW
        findViewById(R.id.btn_raw).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                folioReader.setConfig(config, true)
                        .openBook(R.raw.varun); // здесь описывается название книги
            }
        });

// Открытие документа в фромате EPUB при нажатии на кнопку на главной странице
